...
const lineClasses = {
  base: 'componentsui-step-line absolute w-full group-last:hidden block h-px',
  top: {
    noDot: {
      sm: 'top-[22px]',
      md: 'top-6',
...
export function Step({
  ...
  return (
    ...
    >
      ...
      >
        <span className="componentsui-step-title flex items-center justify-center group-last:inline-block">
          <h2
            className={cn(
