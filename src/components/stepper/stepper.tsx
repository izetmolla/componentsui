...
const containerClasses = {
  ...
  line: '[&>.componentsui-step-line]:hidden',
  verticalLine: {
    base: '[&>.componentsui-step-line]:h-full [&>.componentsui-step-line]:w-px min-h-[100px] last:min-h-0',
    left: {
      noDot: {
        sm: '[&>.componentsui-step-line]:left-3 rtl:[&>.componentsui-step-line]:right-3',
        md: '[&>.componentsui-step-line]:left-3.5 rtl:[&>.componentsui-step-line]:right-3.5',
        lg: '[&>.componentsui-step-line]:left-4 rtl:[&>.componentsui-step-line]:right-4',
      },
      dot: {
        sm: '[&>.componentsui-step-line]:left-[5px] rtl:[&>.componentsui-step-line]:right-[5px]',
        md: '[&>.componentsui-step-line]:left-2 rtl:[&>.componentsui-step-line]:right-2',
        lg: '[&>.componentsui-step-line]:left-2.5 rtl:[&>.componentsui-step-line]:right-2.5',
      },
    },
  },
};
...
const contentClasses = {
  base: '[&>.componentsui-step-title]:justify-start [&>.componentsui-step-title>span]:hidden',
  containerDesc:
    '[&>.componentsui-step-description]:-translate-x-6 rtl:[&>.componentsui-step-description]:translate-x-6 -ml-2 rtl:[&>.componentsui-step-title>h2]:mr-0',
};
