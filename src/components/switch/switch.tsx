...
const switchKnobStyles = {
  ...
  outlineInactiveDisabled:
    '[&:hover_.componentsui-switch-knob]:!bg-muted [&:hover_.componentsui-switch-knob]:!text-muted-foreground',
  rounded: {
    none: 'rounded-none',
    sm: 'rounded-sm',
    md: 'rounded',
  ...
  outlineInactiveColor:
    '[&:hover_.componentsui-switch-knob]:bg-primary [&:hover_.componentsui-switch-knob]:text-primary-foreground',
  translate: {
    active: {
      sm: '[&:checked+span>.componentsui-switch-knob]:translate-x-[.88rem] rtl:[&:checked+span>.componentsui-switch-knob]:-translate-x-[.88rem]',
      md: '[&:checked+span>.componentsui-switch-knob]:translate-x-[1.14rem] rtl:[&:checked+span>.componentsui-switch-knob]:-translate-x-[1.14rem]',
      lg: '[&:checked+span>.componentsui-switch-knob]:translate-x-[1.36rem] rtl:[&:checked+span>.componentsui-switch-knob]:-translate-x-[1.36rem]',
      xl: '[&:checked+span>.componentsui-switch-knob]:translate-x-[1.6rem] rtl:[&:checked+span>.componentsui-switch-knob]:-translate-x-[1.6rem]',
    },
...
export const Switch = forwardRef<HTMLInputElement, SwitchProps>(
  (
    ...
    return (
      <div className={cn('componentsui-switch', className)}>
        <label
          className={cn(
        ...
        >
          <input
            ...
            disabled={disabled}
            className={cn(
              'peer/switch absolute -z-[1] opacity-0 [&:checked:enabled~span_.componentsui-switch-off-icon]:hidden [&:checked:enabled~span_.componentsui-switch-on-icon]:opacity-100',
              '[&:checked:enabled~span>.componentsui-switch-knob]:bg-white [&:checked:enabled~span>.componentsui-switch-knob]:text-black',
              '[&:checked:enabled~span>.componentsui-switch-knob]:dark:bg-black [&:checked:enabled~span>.componentsui-switch-knob]:dark:text-white',
          ...
          >
            <span
              className={cn(
                'componentsui-switch-knob relative',
            ...
            >
              <span className="componentsui-switch-off-icon inline-flex items-center">
                {offIcon}
              </span>
              <span className="componentsui-switch-on-icon absolute inset-0 inline-flex items-center justify-center opacity-0">
                {onIcon || (
                  // HeroIcon: check
                  <svg
